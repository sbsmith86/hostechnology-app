        ...
        <div className="bg-base-200 min-h-screen">
            <div className="max-w-7xl lg:flex lg:flex-row mx-auto">
                <div className="lg:w-1/2 place-content-center lg:p-12">
                    <div className="p-6">
                        <h1 className="font-montserrat text-5xl md:text-6xl font-bold tracking-tight secondary sm:text-4xl lg:text-6xl">
                        ...
                        <p className="font-montserrat text-md font-bold py-4">Expert React, Node, and PHP development and support</p>
                    </div>
                    <ContactForm />
                </div>
